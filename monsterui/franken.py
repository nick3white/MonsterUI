...
def CodeBlock(
    ...
    **kwargs,  # Additional args for Code tag
    ...
    return Div(
        Pre(
            Code(*c, cls=("uk-codeblock", stringify(code_cls)), **kwargs),
            cls=(
...
# %% ../nbs/02_franken.ipynb
def H1(
    *c: FT | str,  # Contents of H1 tag (often text)
...
# %% ../nbs/02_franken.ipynb
def H2(
    *c: FT | str,  # Contents of H2 tag (often text)
...
# %% ../nbs/02_franken.ipynb
def H3(
    *c: FT | str,  # Contents of H3 tag (often text)
...
# %% ../nbs/02_franken.ipynb
def H4(
    *c: FT | str,  # Contents of H4 tag (often text)
...
# %% ../nbs/02_franken.ipynb
def H5(
    *c: FT | str,  # Contents of H5 tag (often text)
...
def H6(
    *c: FT | str,  # Contents of H6 tag (often text)
...
# %% ../nbs/02_franken.ipynb
def Subtitle(
    *c: FT | str,  # Contents of P tag (often text)
...
# %% ../nbs/02_franken.ipynb
def Q(
    *c: FT | str,  # Contents of Q tag (quote)
...
def Em(
    *c: FT | str,  # Contents of Em tag (emphasis)
    cls: Enum | str | tuple = (),  # Additional classes
...
def Strong(
    *c: FT | str,  # Contents of Strong tag
    cls: Enum | str | tuple = (),  # Additional classes
...
def Small(
    *c: FT | str,  # Contents of Small tag
    cls: Enum | str | tuple = (),  # Additional classes
...
def Mark(
    *c: FT | str,  # Contents of Mark tag (highlighted text)
    cls: Enum | str | tuple = (),  # Additional classes
...
# %% ../nbs/02_franken.ipynb
def Del(
    *c: FT | str,  # Contents of Del tag (deleted text)
    cls: Enum | str | tuple = (),  # Additional classes
...
def Ins(
    *c: FT | str,  # Contents of Ins tag (inserted text)
    cls: Enum | str | tuple = (),  # Additional classes
    **kwargs,  # Additional args for Ins tag
) -> FT:
    "Styled inserted text"
    return fh.Ins(
        *c, cls=(TextT.underline + " text-green-600", stringify(cls)), **kwargs
    )


def Sub(
    *c: FT | str,  # Contents of Sub tag (subscript)
    cls: Enum | str | tuple = (),  # Additional classes
...
def Sup(
    *c: FT | str,  # Contents of Sup tag (superscript)
    cls: Enum | str | tuple = (),  # Additional classes
...
# %% ../nbs/02_franken.ipynb
def Blockquote(
    *c: FT | str,  # Contents of Blockquote tag (often text)
...
def Caption(*c: FT | str, cls: Enum | str | tuple = (), **kwargs) -> FT:
    "Styled caption text"
    return fh.Caption(Span(*c, cls=(TextT.gray, TextT.sm, stringify(cls))), **kwargs)


# %% ../nbs/02_franken.ipynb
def Cite(
    *c: FT | str,  # Contents of Cite tag
    cls: Enum | str | tuple = (),  # Additional classes
...
def Address(
    *c: FT | str,  # Contents of Address tag
    cls: Enum | str | tuple = (),  # Additional classes
...
def Dfn(
    *c: FT | str,  # Contents of Dfn tag (definition)
    cls: Enum | str | tuple = (),  # Additional classes
    **kwargs,  # Additional args for Dfn tag
) -> FT:
    "Styled definition term with italic and medium weight"
    return fh.Dfn(
        *c, cls=(TextT.medium + TextT.italic + TextT.gray, stringify(cls)), **kwargs
    )


def Kbd(
    *c: FT | str,  # Contents of Kbd tag (keyboard input)
    cls: Enum | str | tuple = (),  # Additional classes
...
# %% ../nbs/02_franken.ipynb
def Samp(
    *c: FT | str,  # Contents of Samp tag (sample output)
    cls: Enum | str | tuple = (),  # Additional classes
    **kwargs,  # Additional args for Samp tag
    ...
    return fh.Samp(
        *c,
        cls=("font-mono bg-secondary px-1 rounded", TextT.gray, stringify(cls)),
        **kwargs,
    )


def Var(
    *c: FT | str,  # Contents of Var tag (variable)
    cls: Enum | str | tuple = (),  # Additional classes
    **kwargs,  # Additional args for Var tag
) -> FT:
    "Styled variable with italic monospace"
    return fh.Var(
        *c, cls=("font-mono", TextT.italic + TextT.gray, stringify(cls)), **kwargs
    )


# %% ../nbs/02_franken.ipynb
def Figure(
    *c: FT | str,  # Contents of Figure tag
    cls: Enum | str | tuple = (),  # Additional classes
...
# %% ../nbs/02_franken.ipynb
def Details(
    *c: FT | str,  # Contents of Details tag
    cls: Enum | str | tuple = (),  # Additional classes
    **kwargs,  # Additional args for Details tag
) -> FT:
    "Styled details element"
    return fh.Details(
        *c, cls=("border border-secondary rounded-lg", stringify(cls)), **kwargs
    )


def Summary(
    *c: FT | str,  # Contents of Summary tag
    cls: Enum | str | tuple = (),  # Additional classes
    **kwargs,  # Additional args for Summary tag
    ...
    return fh.Summary(
        *c,
        cls=(TextT.medium + " p-3 hover:bg-secondary cursor-pointer", stringify(cls)),
        **kwargs,
    )


def Data(
    *c: FT | str,  # Contents of Data tag
    ...
    **kwargs,  # Additional args for Data tag
    ...
    return fh.Data(
        *c,
        cls=("font-mono text-sm bg-secondary px-1 rounded", stringify(cls)),
        **kwargs,
    )


def Meter(
    *c: FT | str,  # Contents of Meter tag
    ...
    **kwargs,  # Additional args for Meter tag
    ...
    if max is not None:
        kwargs["max"] = max
    return fh.Meter(
        *c, cls=("w-full h-2 bg-secondary rounded", stringify(cls)), **kwargs
    )


# %% ../nbs/02_franken.ipynb
def S(
    *c: FT | str,  # Contents of S tag (strikethrough)
    cls: Enum | str | tuple = (),  # Additional classes
...
def U(
    *c: FT | str,  # Contents of U tag (unarticulated annotation)
    cls: Enum | str | tuple = (),  # Additional classes
...
def Output(
    *c: FT | str,  # Contents of Output tag
    ...
    **kwargs,  # Additional args for Output tag
    ...
    return fh.Output(
        *c, cls=("font-mono bg-secondary px-2 py-1 rounded", stringify(cls)), **kwargs
    )
...
# %% ../nbs/02_franken.ipynb
def AccordionItem(
    title: Union[str, FT],  # Content for the accordion item title
...
# %% ../nbs/02_franken.ipynb
def Button(
    *c: Union[str, FT],  # Contents of `Button` tag (often text)
    cls: Union[
        str, Enum
...
def Switch(
    ...
    **kwargs,  # Additional args for Switch tag
    ...
    return fh.Input(
        *c,
        cls=("uk-toggle-switch uk-toggle-switch-primary min-w-9", stringify(cls)),
        type="checkbox",
        **kwargs,
    )
...
def GenericLabelInput(
    ...
    **kwargs,  # Additional args for user input
    ...
    if container:
        return container(label, inp, cls=stringify(cls))
    return label, inp
...
def LabelRadio(
    ...
    **kwargs,  # Additional args for `Radio`
    ...
    if container:
        return container(inp, label, cls=stringify(cls))
    return inp, label
...
def ModalContainer(
    ...
    **kwargs,  # Additional args for `Div` tag
    ...
    return fh.Div(
        *c,
        cls=("uk-modal uk-modal-container", stringify(cls)),
        data_uk_modal=True,
        **kwargs,
    )
...
def Modal(
    ...
    **kwargs,  # Additional args for the outermost `Div` tag
    ...
    cls, dialog_cls, header_cls, body_cls, footer_cls = map(
        stringify, (cls, dialog_cls, header_cls, body_cls, footer_cls)
    )
    res = []
    if header:
        res.append(ModalHeader(cls=header_cls)(header))
    res.append(ModalBody(cls=body_cls)(*c))
    if footer:
        res.append(ModalFooter(cls=footer_cls)(footer))
...
def Progress(
    ...
    **kwargs,  # Additional args for `Progress` tag
    ...
    return fh.Progress(
        *c, value=value, max=max, cls=("uk-progress", stringify(cls)), **kwargs
    )
...
def UkIconLink(
    ...
    **kwargs,  # Additional args for `A` or `Button` tag
    ...
    return fn(
        cls=(f"uk-icon-{'button' if button else 'link'}", stringify(cls)), **kwargs
...
def NavContainer(
    ...
    **kwargs,  # Additional args
    ...
    return fh.Ul(
        *li,
        uk_nav=uk_nav,
        cls=(f"uk-nav{'' if parent else '-sub'}", stringify(cls), _sticky),
    ...
    return Div(
        Div(
            DivFullySpaced(
                ...
                Div(
                    *c,
                    cls=(stringify(right_cls), "hidden md:flex"),
        ...
        DivCentered(
            *c,
            cls=(
                stringify(mobile_cls),
                stringify(cls),
                stringify(scrollspy_cls),
...
def DropDownNavContainer(
    ...
    **kwargs,  # Additional args for the nav
    ...
    return Div(cls="uk-drop uk-dropdown", uk_dropdown=uk_dropdown)(
        NavContainer(
            *li,
            cls=("uk-dropdown-nav", stringify(cls)),
            uk_nav=uk_nav,
            parent=parent,
            **kwargs,
        )
...
def Card(
    ...
    **kwargs,  # additional arguments for the `CardContainer`
    ...
    header_cls, footer_cls, body_cls, cls = map(
        stringify, (header_cls, footer_cls, body_cls, cls)
    )
    res = []
    if header:
...
def Tbody(*rows, cls=(), sortable=False, **kwargs):
    return fh.Tbody(*rows, cls=stringify(cls), uk_sortable=sortable, **kwargs)
...
def TableFromDicts(
    ...
    body_cell_render=lambda k, v: Td(
        v
    ),  # Function(key, content) -> FT that renders body cells
    footer_cell_render=lambda k, v: Td(
        v
    ),  #  Function(key, content) -> FT that renders footer cells
    cls=(
        TableT.middle,
        TableT.divider,
        TableT.hover,
...
def ThemePicker(
    ...
    def _optgrp(key, lbl, opts):
        return fh.Optgroup(data_key=key, label=lbl)(*opts)
...
def LoaderButton(
    *c, cls="uk-btn-default", icon_func=partial(UkIcon, icon="loader"), **kwargs
    ...
    return Button(
        ...
        cls=stringify((cls, "relative group disabled:cursor-not-allowed")),
        **kwargs,
    )
